...
namespace ExileCore2.PoEMemory.Components
{
	...
	{
		// Token: 0x06001A22 RID: 6690 RVA: 0x001EAD3C File Offset: 0x001EAD3C
		public Sockets()
		{
			this;
			this;
		...
		// (get) Token: 0x06001A23 RID: 6691 RVA: 0x001EAD54 File Offset: 0x001EAD54
		public List<SocketTypes> SocketList
		{
			get
			{
				/*
...
ICSharpCode.Decompiler.DecompilerException: Error decompiling System.Collections.Generic.List`1<ExileCore2.Shared.Enums.SocketTypes> ExileCore2.PoEMemory.Components.Sockets::get_SocketList()
...
*/;
		...
		// (get) Token: 0x06001A24 RID: 6692 RVA: 0x001EAE00 File Offset: 0x001EAE00
		...
		// (get) Token: 0x06001A25 RID: 6693 RVA: 0x001EAE10 File Offset: 0x001EAE10
		public List<Sockets.SocketedItem> SocketedItems
		{
			get
			{
				/*
...
ICSharpCode.Decompiler.DecompilerException: Error decompiling System.Collections.Generic.List`1<ExileCore2.PoEMemory.Components.Sockets/SocketedItem> ExileCore2.PoEMemory.Components.Sockets::get_SocketedItems()
...
*/;
		...
		// (get) Token: 0x06001A26 RID: 6694 RVA: 0x001EAED0 File Offset: 0x001EAED0
		public List<Sockets.Socket> SocketInfo
		{
			get
			{
				return this;
		...
		// Token: 0x06001A27 RID: 6695 RVA: 0x001EAED8 File Offset: 0x001EAED8
		public List<Sockets.Socket> GetSocketInfo()
		{
			/*
An exception occurred when decompiling this method (06001A27)

ICSharpCode.Decompiler.DecompilerException: Error decompiling System.Collections.Generic.List`1<ExileCore2.PoEMemory.Components.Sockets/Socket> ExileCore2.PoEMemory.Components.Sockets::GetSocketInfo()
...
*/;
		...
		{
			// Token: 0x06001A29 RID: 6697 RVA: 0x001EAFAC File Offset: 0x001EAFAC
			public SocketedItem()
			{
				this;
			}
		...
		public class Socket
		{
			// Token: 0x06001A2A RID: 6698 RVA: 0x001EAFB8 File Offset: 0x001EAFB8
			public Socket(SocketTypes socketType, int socketIndex, Entity itemEntity)
			{
				/*
An exception occurred when decompiling this method (06001A2A)

ICSharpCode.Decompiler.DecompilerException: Error decompiling System.Void ExileCore2.PoEMemory.Components.Sockets/Socket::.ctor(ExileCore2.Shared.Enums.SocketTypes,System.Int32,ExileCore2.PoEMemory.MemoryObjects.Entity)
...
*/;
			...
			// Token: 0x06001A2B RID: 6699 RVA: 0x001EB00C File Offset: 0x001EB00C
			public override string ToString()
			{
				/*
An exception occurred when decompiling this method (06001A2B)

ICSharpCode.Decompiler.DecompilerException: Error decompiling System.String ExileCore2.PoEMemory.Components.Sockets/Socket::ToString()
